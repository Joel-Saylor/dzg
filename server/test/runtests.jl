...
# !!! Main.UserApp is configured as an alias for Main.Server and you might encounter it in some tests
using Main.Server, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Server tests" begin
  @includetests ARGS
end
