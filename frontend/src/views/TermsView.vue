<template>
  <div class="w-[80%] mx-auto">
    ...
    <br />
    <p>Welcome to DZ grainalyzer</p>
    <br />
    <p>
      These terms and conditions outline the rules and regulations for the use
      of DZ grainalyzer's Website, located at https://dzgrainalyzer.eoas.ubc.ca.
    </p>
    <br />
    <p>
      By accessing this website we assume you accept these terms and conditions.
      Do not continue to use DZ grainalyzer if you do not agree to take all of
    ...
    <p>
      Unless otherwise stated, DZ grainalyzer and/or its licensors own the
      intellectual property rights for all material on DZ grainalyzer. All
      intellectual property rights are reserved. You may access this from DZ
      grainalyzer for your own personal use subjected to restrictions set in
    ...
    <p>We approve the following types of organizations as well:</p>
